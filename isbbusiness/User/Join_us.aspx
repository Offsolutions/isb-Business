...
<asp:Content ID="Content1" ContentPlaceHolderID="cptitle" Runat="Server">
    ...
    <h3 class="text-white">JOIN ISB BUSINESS</h3>
    ...
    <div class=" container">
        <div class="col-md-9">
            ...
            <div class="form-group col-sm-12" style="display:none">
                <label for="First Name">ProposerId </label>
            ...
            <div class="form-group col-sm-12">
               ...
               <%--  <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"  
                    ControlToValidate="txtphn" ErrorMessage="enter 10 digit phone no."  
           ...
           <%--     <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"  
                    ControlToValidate="txtaadhar" ErrorMessage="enter 12 digit adhar no."  
...
<%--                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
            ...
            <div class="form-group col-sm-12">
                <asp:Button ID="btnjoin" ValidationGroup="a" class="btn btn-primary" OnClick="btnjoin_Click" runat="server" Text="Join Now" />
